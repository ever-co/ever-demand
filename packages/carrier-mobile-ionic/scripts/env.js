...
exports.env = envalid_1.cleanEnv(process.env, {
    ...
    DEFAULT_CUSTOMER_LOGO: envalid_1.str({
        default: 'http://res.cloudinary.com/evereq/image/upload/v1536843011/everbie-products-images/btzn3o8pimhercepno2d.png'
    }),
    LOGIN_LOGO: envalid_1.str({ default: 'assets/imgs/ever-logo.svg' }),
    NO_INTERNET_LOGO: envalid_1.str({ default: 'assets/imgs/ever-logo.svg' }),
